...
const IntroSection = ({ scrollToRef}) => {
      ...
      <Container maxWidth="100%" disableGutters  sx={{marginTop:1}}>
        <Box sx={{ bgcolor: '#F3F3F3', height: '60vh',display:'flex',paddingX:10 ,justifyContent:'space-between',alignItems:'center' }} >
          <Box sx={{display:'flex' ,flexDirection:'column',gap:2}}>
            <Typography variant='h6' sx={{color:'var(--primary-color)',fontWeight:600}}>Step Into Greatness</Typography>
            ...
            <Button variant="contained"   onClick={handleExploreClick} sx={{ cursor:'pointer' ,backgroundColor:'#28665B', width:150 ,marginTop:3}}>Exolpre Now</Button>
          </Box>
