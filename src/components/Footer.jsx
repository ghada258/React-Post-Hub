          ...
          <Box sx={{display:'flex' , flexDirection :'column' ,gap:3}}>
           <Box component="img" src="logo_footer.svg" alt="logo"   sx={{ width: 250, height: 'auto' }} />
            ...
            <Box sx={{display:'flex',alignItems:'center' ,gap:1}}>
                 <Box component="img" src="facebook.svg" alt="logo"  sx={{ paddingX:2 ,paddingY:1,width: 13,bgcolor:'var(--footer-text)', height: 'auto',borderRadius:1 }} />
                  <TwitterIcon baseClassName="fas"  sx={{color:'var(--primary-color)',bgcolor:'var(--footer-text)',padding:1,borderRadius:1}}  />
                 <InstagramIcon baseClassName="fas" sx={{color:'var(--primary-color)',bgcolor:'var(--footer-text)',padding:1,borderRadius:1}}  />
            </Box>
          </Box>  
